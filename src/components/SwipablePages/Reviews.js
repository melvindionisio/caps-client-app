...
const Reviews = () => {
   ...
   const [sentReviewMessage, setSentReviewMessage] = useState("");
         ...
         if (reviewText !== "") {
            ...
            fetch(`${domain}/api/reviews/add/${bhId}`, {
               ...
               .then((data) => {
                  ...
                  setSentReviewMessage(
                     "Your review was successfully sent. Please wait for the admin to approve your request."
                  );
                  setIsPending(true);
                  setTimeout(() => {
                     setIsModalOpen(false);
         ...
         >
            ...
            >
               ...
               <Typography variant="caption" sx={{ px: 2 }}>
                  Please note that your review will need to be verified by the
                  admin before it appears here.
               </Typography>
               {isEmpty && (
                  <Typography
                     variant="body2"
